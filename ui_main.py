...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.textEdit.textChanged.connect(self.updateLineCount)

        self.lineCountLabel = QLabel(self.widget)
        self.lineCountLabel.setObjectName(u"lineCountLabel")
        
        self.horizontalLayout.addWidget(self.lineCountLabel)
    ...
    def updateLineCount(self):
        ...
        self.lineCountLabel.setText(f"num\n{line_count}")
    
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"\u751f\u6210\u6761\u5f62\u7801", None))
        self.line_Edit_module_width.setPlaceholderText(QCoreApplication.translate("MainWindow", u"\u6761\u5f62\u7801\u5bbd\u5ea6\uff0c\u9ed8\u8ba40.3", None))
        self.lineEdit_module_height.setPlaceholderText(QCoreApplication.translate("MainWindow", u"\u6761\u5f62\u7801\u9ad8\u5ea6\uff0c\u9ed8\u8ba410", None))
        self.lineEdit_font_size.setPlaceholderText(QCoreApplication.translate("MainWindow", u"\u5b57\u4f53\u5927\u5c0f\uff0c\u9ed8\u8ba49", None))
        self.lineEdit_quiet_zone.setPlaceholderText(QCoreApplication.translate("MainWindow", u"\u4e24\u8fb9\u7a7a\u767d\u5bbd\u5ea6\uff0c\u9ed8\u8ba40", None))
        self.lineEdit_text_distance.setPlaceholderText(QCoreApplication.translate("MainWindow", u"\u4e0b\u65b9\u6587\u672c\u8ddd\u79bb\u6761\u5f62\u7801\u8ddd\u79bb\uff0c\u9ed8\u8ba45.0", None))
        self.lineEdit_write_text.setPlaceholderText(QCoreApplication.translate("MainWindow", u"\u662f\u5426\u5c55\u793a\u6761\u5f62\u7801\u5bf9\u5e94\u6587\u5b57\uff0c\u9ed8\u8ba4\u5c55\u793a\uff0cTure/False", None))
        self.lineEdit_dpi.setPlaceholderText(QCoreApplication.translate("MainWindow", u"dpi\uff0c\u9ed8\u8ba4300", None))
        self.lineEdit_write_path.setPlaceholderText(QCoreApplication.translate("MainWindow", u"\u8f93\u51fa\u56fe\u7247\u8def\u5f84\uff0c\u9ed8\u8ba4\u5f53\u524d\u76ee\u5f55", None))
        self.textEdit.setPlaceholderText(QCoreApplication.translate("MainWindow", u"\u8bf7\u8f93\u5165\u8981\u751f\u6210\u7684\u6761\u5f62\u7801\uff0c\u591a\u4e2a\u4ee5\u56de\u8f66\u5206\u9694", None))
        self.button.setText(QCoreApplication.translate("MainWindow", u"\u751f\u6210\u6761\u5f62\u7801", None))
        self.lineCountLabel.setText(f"num\n0")
    # retranslateUi
